	...
	implements ElexisEventListener
{
	...
	public void init() {
		...
		eetmpl = new ElexisEvent(null, pclass, ElexisEvent.EVENT_SELECTED |
						ElexisEvent.EVENT_DESELECTED | ElexisEvent.EVENT_DELETE);
	...
	/**
	 * Wird aufgerufen wenn das aktuelle PersistentObject nicht mehr
	 * ausgewaehlt ist. Wird im GUI Thread gestartet.
	 */
	protected void deselected(P po) {}
	
	/**
	 * Wird aufgerufen wenn ein neues PersistentObject ausgewaehlt wurde. Wird
	 * im GUI Thread gestartet.
	 */
